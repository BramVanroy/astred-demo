...
class Sentence extends Component {
  ...
  buildWordClass(wordIdx, alignedIdxs) {
    ...
    if (!this.props.isAstred && this.props.clicked[otherSide] !== null && this.props.clicked[side] === null) {
...
Sentence.propTypes = {
  ...
  isAstred: PropTypes.bool,
  onClickSentence: PropTypes.func,
  onMouseOverSentence: PropTypes.func,
  removeHovered: PropTypes.func,
