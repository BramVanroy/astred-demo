...
import {createStrFromAligns, removeItemfromArray} from '../utils';
...
class AlignViz extends PureComponent {
  ...
  setSvgWidth() {
    if (this.alignVizDom.current) {
      // Not sure why but in development this.alignVizDom.current sometimes is undefined
